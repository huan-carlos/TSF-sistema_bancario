...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/actions/workflow/status/huan-carlos/TSF-sistema_bancario/maven.yml[GitHub Workflow Status (with event)]
