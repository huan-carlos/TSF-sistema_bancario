...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/huan-carlos/TSF-sistema_bancario/maven[GitHub Workflow Status]
