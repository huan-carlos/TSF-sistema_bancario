...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/huan-carlos/TSF-sistema_bancario/Java%20CI%20with%20Maven[GitHub Workflow Status]
